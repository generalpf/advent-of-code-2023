...
func unvisitedNodes(from: Node, unvisited: [Node]) -> [Node] {
    var un = [Node]()
    // look west.
    if from.x > 0, from.direction != .east, !(from.direction == .west && from.distance == 3) {
    ...
    // look east.
    if from.x < width - 1, from.direction != .west, !(from.direction == .east && from.distance == 3) {
    ...
    // look north.
    if from.y > 0, from.direction != .south, !(from.direction == .north && from.distance == 3) {
    ...
    // look south.
    if from.y < height - 1, from.direction != .north, !(from.direction == .south && from.distance == 3) {
